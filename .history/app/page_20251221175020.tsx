...
// --- DATABASE GOKAIGER ONLY (Synchronized Paths) ---
const allCharacters = [
  { 
    id: "gokai-red", 
    name: "Gokai Red", 
    group: "Super Sentai", 
    // Using the same path structure as your detail page
    img: "/sentai/marvelous/Captain_Marvelous.webp" 
  },
  { 
    id: "gokai-blue", 
    name: "Gokai Blue", 
    group: "Super Sentai", 
    img: "/sentai/joe/Joe_Gibken.webp" 
  },
  { 
    id: "luka-millfy", 
    name: "Gokai Yellow", 
    group: "Super Sentai", 
    img: "/sentai/luka/Luka_Millfy.webp" 
  },
  { 
    id: "gokai-green", 
    name: "Gokai Green", 
    group: "Super Sentai", 
    img: "/sentai/don/Don_Dogoier.webp" 
  },
  { 
    id: "gokai-pink", 
    name: "Gokai Pink", 
    group: "Super Sentai", 
    img: "/sentai/ahim/ahim.png" 
  },
  { 
    id: "gokai-silver", 
    name: "Gokai Silver", 
    group: "Super Sentai", 
    img: "/sentai/gai/Gai_Ikari.webp" 
  },
]
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {filters.map(filter => (
              <button 
                ...
                className={`px-6 py-2 rounded-full border text-sm font-bold uppercase tracking-wider transition-all duration-300 ${activeFilter === filter ? "bg-primary border-primary text-white scale-105" : "bg-transparent border-white/10 text-gray-400 hover:text-white"}`}
              >
                {filter}
              </button>
            ))}
      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-12 py-12">
          ...
          {filteredChars.map((char, idx) => (
            ...
            >
              ...
              <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <Badge className="bg-primary/80 backdrop-blur-sm text-[10px] uppercase font-bold">{char.group}</Badge>
              </div>
            </Link>
          ))}
        </div>
        ...
        {filteredChars.length === 0 && (
          <div className="text-center py-32 opacity-50">
            ...
            <h3 className="text-2xl font-oswald text-gray-400 uppercase">Data Not Found</h3>
          </div>
        )}
      </div>
    </div>
