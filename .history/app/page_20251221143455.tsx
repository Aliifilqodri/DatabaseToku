...
const heroEntries = [
  {
    ...
    title: "GEATS",
    subtitle: "ACE UKIYO",
    desc: "The star of the Desire Grand Prix. Using the Desire Driver and ID Core, he transforms into Geats to reshape the world.",
    image: "/kamen-rider-geats-superhero-mask.jpg", 
    logo: "GEATS",
    stats: { punch: "2.8 t", kick: "5.8 t", height: "205 cm", weight: "78 kg" },
    year: "2022",
    motif: "Fox"
  },
  {
    ...
    title: "KING-OHGER",
    subtitle: "GIRA HUSTY",
    desc: "The self-proclaimed Evil King who leads the rebellion against the Bugnarak Empire using the Ohger Calibur.",
    image: "/super-sentai-king-ohger-team.jpg",
    logo: "KING-OHGER",
    stats: { punch: "15.0 t", kick: "28.0 t", height: "198 cm", weight: "95 kg" },
    year: "2023",
    motif: "Beetle"
  },
  {
    ...
    title: "BLAZAR",
    subtitle: "CODE V99",
    desc: "A giant of light from a far-off galaxy with a primitive fighting style that defies tactical data.",
    image: "/ultraman-decker-silver-hero.jpg",
    logo: "BLAZAR",
    stats: { punch: "Unknown", kick: "Unknown", height: "47 m", weight: "42k t" },
    year: "2023",
    motif: "Hunter"
  }
]
...
const wikiCategories = [
  { 
    title: "Reiwa Era Riders", 
    desc: "The new generation of Kamen Riders starting from 2019.",
    items: [{id: 1, title: "Zero-One", year: "2019"}, {id: 2, title: "Geats", year: "2022"}, {id: 3, title: "Gotchard", year: "2023"}] 
  },
  { 
    title: "Super Sentai Mecha", 
    desc: "Giant robots and machines used to battle enlarged threats.",
    items: [{id: 4, title: "King-Ohger", year: "2023"}, {id: 5, title: "Don Onitaijin", year: "2022"}, {id: 6, title: "Kiramajin", year: "2020"}] 
  }
]
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] font-sans selection:bg-primary selection:text-white overflow-x-hidden">
          ...
          <div className="grid w-full grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-in slide-in-from-left duration-700">
              <div className="inline-flex items-center gap-2 rounded-full border border-primary/50 bg-primary/10 px-3 py-1 text-xs font-mono text-primary tracking-widest uppercase">
                 <div className="h-2 w-2 rounded-full bg-primary animate-pulse"/> Database Entry #{current + 1}
              </div>
              ...
              <div className="flex gap-3">
                 ...
                 <Badge variant="outline" className="text-gray-300 border-gray-600 text-sm px-3 rounded-sm uppercase">Motif: {activeHero.motif}</Badge>
              </div>
            ...
            <div className="hidden lg:flex justify-end animate-in fade-in zoom-in duration-1000 delay-200">
               <div className="glass-panel w-96 p-8 rounded-xl relative overflow-hidden">
                  ...
                  <div className="space-y-5 font-mono text-sm text-gray-300">
                     ...
                     <div className="h-1 w-full bg-gray-800 rounded-full overflow-hidden"><div className="h-full bg-primary w-[40%]"/></div>
                     ...
                     <div className="h-1 w-full bg-gray-800 rounded-full overflow-hidden"><div className="h-full bg-primary w-[70%]"/></div>
      ...
      {/* WIKI ROWS (Simplified for display) */}
      <div className="relative z-10 bg-[#0a0a0a] pb-20">
        <div className="bg-zinc-900/50 border-y border-white/5 py-8 px-6 sm:px-16 text-center backdrop-blur-sm">
           <h3 className="font-oswald text-xl text-white mb-4 uppercase tracking-widest">Search the Archives</h3>
           <div className="relative max-w-md mx-auto">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500" size={18} />
              <input 
                 type="text" 
                 placeholder="Find Rider, Kaiju, or Mecha..." 
                ...
                <div key={i}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {cat.items.map((item, j) => (
                            <div key={j} className="aspect-[3/4] bg-zinc-900 border border-white/5 rounded-lg overflow-hidden group cursor-pointer relative hover:border-primary transition-colors">
                                {/* Placeholder Image logic - replace src with real images */}
                                ...
                                <div className="absolute bottom-3 left-3">
                                    <span className="text-[10px] text-primary font-mono">{item.year}</span>
