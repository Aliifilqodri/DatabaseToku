...
// --- MOCK DATABASE (GOKAIGER VERSION) ---
const seriesDatabase: any = {
  "kaizoku-sentai-gokaiger": {
    ...
    rating: 5.0,
    image: "/sentai/Gokaiger_29.webp", // Pastikan file gambar ini ada
    color: "from-red-600 to-yellow-500",
    trailerId: "P8t4_s0Z7zM", // Youtube ID dummy
    cast: [
      {
...
export default function SeriesWikiPage({
  ...
  useEffect(() => {
    // Default ke Gokaiger jika ID tidak ditemukan atau user masuk tanpa ID spesifik
    // (Untuk demo ini saya paksa ambil data gokaiger)
    const found =
  ...
  if (!data)
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white">
        <h1 className="text-4xl font-oswald mb-4">404 - DATA NOT FOUND</h1>
        <Link href="/">
