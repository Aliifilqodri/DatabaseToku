...
const allMovies = [
  ...
  // 2. GOKAIGER (Main Focus)
  {
    ...
    type: "Anniversary",
    img: "/movie/R.jpeg", // Ganti dengan poster 199 Hero
    rating: "5.0",
  },
  {
    id: 5,
    ...
    type: "Theatrical",
    img: "/movie/OIP.jpeg", // Ganti dengan poster Ghost Ship
    rating: "4.8",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    series: "Kaizoku Sentai Gokaiger",
    type: "V-Cinext",
    img: "/movie/91z-idQ1JbL._SL1378_.jpg", // Ganti dengan poster Ten Gokaiger
    rating: "5.0",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans">
      ...
      <div className="relative h-[55vh] w-full overflow-hidden">
        <img
          src="/movie/Ten-Gokaiger.jpg" // Pastikan gambar ada
          alt="Featured"
        ...
        <div className="absolute bottom-0 left-0 p-8 sm:p-16 max-w-5xl">
          <Badge className="bg-primary text-white mb-4 px-3 py-1 font-bold animate-in fade-in slide-in-from-left duration-700">
            10TH ANNIVERSARY
          </Badge>
          ...
          <Button className="h-12 px-8 bg-white text-black hover:bg-gray-200 font-bold uppercase rounded-sm animate-in fade-in duration-1000 delay-300">
            <Ticket className="mr-2" size={20} /> Best Movie
          </Button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-12">
                      ...
                      >
                        <div className="aspect-[2/3] w-full bg-zinc-800 relative overflow-hidden">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                            <PlayCircle
                              size={40}
                              className="text-white drop-shadow-lg scale-75 group-hover:scale-100 transition-transform"
                            />
                          </div>
                        </div>
        ...
        {filteredMovies.length === 0 && (
          <div className="text-center py-20 opacity-50">
            ...
            <h3 className="text-xl font-oswald text-gray-400 uppercase">
              No Movies Found
            </h3>
            <p className="text-gray-500 text-sm">
              We are currently updating our archives for {activeFilter}.
            </p>
          </div>
        )}
      </div>
