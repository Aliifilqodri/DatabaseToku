  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-primary selection:text-white">
      ...
      <AlertDialog open={alertOpen} onOpenChange={setAlertOpen}>
        <AlertDialogContent className="bg-[#0a0a0a] border border-white/10 text-white shadow-2xl shadow-black/90">
          <AlertDialogHeader>
            <AlertDialogTitle className="font-oswald text-2xl uppercase flex items-center gap-3 text-yellow-500">
              <AlertTriangle className="h-6 w-6" /> Database Locked
            </AlertDialogTitle>
            <AlertDialogDescription className="text-gray-400 text-base leading-relaxed">
              This Archive entry is currently classified or under maintenance. 
              <br/><br/>
              Only <strong>Kaizoku Sentai Gokaiger</strong> data is currently declassified for public viewing.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction className="bg-white text-black hover:bg-gray-200 font-bold uppercase tracking-wider rounded-none clip-angle px-6">
              Acknowledge
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
