...
export default function MoviesPage() {
  ...
  // Handle click to prevent 404 on unfinished pages
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans">
      ...
      <div className="relative h-[55vh] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-8 sm:p-16 max-w-5xl">
          ...
          {/* Link to Ten Gokaiger (ID: 8) which is valid */}
          <Link href="/movie/8">
        ...
        <AlertDialogContent className="bg-zinc-950 border border-white/10 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-400">
              This Wiki entry is currently under construction by the archive
              team. Only <strong>Gokaiger</strong> data is available for public
              viewing.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
