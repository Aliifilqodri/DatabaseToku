...
import { Eye, Star, Ticket, Film, Filter, AlertTriangle } from "lucide-react";
        ...
        <AlertDialogContent className="bg-zinc-950 border border-white/10 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-400">
              This Wiki entry is currently classified or under construction.
              Only <strong>Gokaiger</strong> data is available for public
              viewing at this moment.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
