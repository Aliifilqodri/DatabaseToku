...
const characterDatabase: Record<string, CharacterData> = {
  ...
  "gokai-silver": {
    ...
    series: "Kaizoku Sentai Gokaiger",
    color: "Silver",
    themeColor: "text-gray-300 border-gray-300 selection:bg-gray-300 selection:text-black",
    ...
    mecha: [
      { name: "GoZyuDrill", image: "/sentai/gokaiger/mecha_gozyu_drill.webp" },
      { name: "GoZyuRex", image: "/sentai/gokaiger/mecha_gozyu_rex.webp" },
      { name: "GoZyuJin", image: "/sentai/gokaiger/mecha_gozyu_jin.webp" },
    ],
    trivia: [
