...
import { ArrowLeft, PlayCircle, Star, Calendar, Filter } from "lucide-react"

// --- DATA MOCKUP DATABASE ---
// Di aplikasi asli, ini biasanya diambil dari API/Database
const genreDatabase: Record<string, { title: string; desc: string; banner: string; color: string }> = {
  "kamen-rider": {
    ...
    banner: "/kamen-rider-geats-superhero-mask.jpg", // Ganti dengan gambar banner Kamen Rider
  ...
  "super-sentai": {
    ...
    banner: "/super-sentai-king-ohger-team.jpg", // Ganti dengan gambar banner Sentai
    color: "text-red-500"
  },
  "ultraman": {
    ...
    banner: "/ultraman-decker-silver-hero.jpg", // Ganti dengan gambar banner Ultraman
    color: "text-blue-500"
  },
  "metal-heroes": {
    title: "Metal Heroes",
...
const allSeries = [
  // Kamen Rider
  { id: "geats", title: "Kamen Rider Geats", genre: "kamen-rider", year: "2022", era: "Reiwa", img: "/kamen-rider-geats-superhero-mask.jpg", rating: 4.9 },
  { id: "zero-one", title: "Kamen Rider Zero-One", genre: "kamen-rider", year: "2019", era: "Reiwa", img: "/placeholder.svg", rating: 4.8 },
  { id: "build", title: "Kamen Rider Build", genre: "kamen-rider", year: "2017", era: "Heisei", img: "/placeholder.svg", rating: 4.9 },
  { id: "w", title: "Kamen Rider W", genre: "kamen-rider", year: "2009", era: "Heisei", img: "/placeholder.svg", rating: 5.0 },
  ...
  // Ultraman
  { id: "blazar", title: "Ultraman Blazar", genre: "ultraman", year: "2023", era: "Reiwa", img: "/ultraman-decker-silver-hero.jpg", rating: 4.8 },
  { id: "decker", title: "Ultraman Decker", genre: "ultraman", year: "2022", era: "Reiwa", img: "/placeholder.svg", rating: 4.6 },
  { id: "tiga", title: "Ultraman Tiga", genre: "ultraman", year: "1996", era: "Heisei", img: "/placeholder.svg", rating: 5.0 },
]
...
export default async function GenrePage({
  ...
  // Ambil data info genre (jika tidak ada, pakai default)
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary selection:text-white">
      ...
      <div className="relative h-[50vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-12 lg:p-20">
          <div className="animate-in slide-in-from-bottom-10 fade-in duration-700 delay-100 max-w-4xl">
            <Link href="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-4 transition-colors text-sm font-medium">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-12">
        ...
        {/* Series Grid with Staggered Animation */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {filteredSeries.map((series, index) => (
              <Link 
                ...
                style={{ animationDelay: `${index * 100}ms` }} // Staggered delay effect
              >
                {/* Card Container */}
                <div className="aspect-[2/3] overflow-hidden rounded-lg bg-zinc-900 border border-white/5 shadow-lg transition-all duration-300 group-hover:shadow-primary/20 group-hover:border-primary/50 group-hover:-translate-y-2">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/60 opacity-0 backdrop-blur-[2px] transition-opacity duration-300 group-hover:opacity-100">
                    <PlayCircle className="h-12 w-12 text-white drop-shadow-lg scale-50 transition-transform duration-300 group-hover:scale-100" />
                  </div>
