...
// --- DATABASE GENRE ---
const genreDatabase: Record<string, { title: string; desc: string; banner: string; color: string }> = {
  "kamen-rider": {
    ...
    banner: "/kamen-rider-geats-superhero-mask.jpg",
  ...
  "super-sentai": {
    ...
    banner: "/super-sentai-king-ohger-team.jpg",
    color: "text-red-500"
  },
  "ultraman": {
    ...
    banner: "/ultraman-decker-silver-hero.jpg",
    color: "text-blue-500"
  },
  "metal-heroes": {
    title: "Metal Heroes",
    desc: "Space Sheriffs and cyborg police officers clad in metallic combat suits fighting criminal syndicates.",
    banner: "/metal-heroes-banner.jpg", // Pastikan ada atau ganti placeholder
    color: "text-gray-400"
  },
  "chouseishin": {
    title: "Chouseishin Series",
    desc: "The Star God Series produced by Toho. Ordinary people are awakened as warriors to defend Earth from alien invaders seeking to revive ancient powers.",
    banner: "/chouseishin/gransazer-banner.jpg", // Ganti dengan gambar Gransazer/Sazer X
...
const allSeries = [
  // Kamen Rider
  { id: "geats", title: "Kamen Rider Geats", genre: "kamen-rider", year: "2022", era: "Reiwa", img: "/kr/kamen-rider-geats-updated-poster-with-all-riders-revealed-v0-y8sp6kg027g91.webp", rating: 4.9 },
  { id: "zero-one", title: "Kamen Rider Zero-One", genre: "kamen-rider", year: "2019", era: "Reiwa", img: "/kr/OIP.webp", rating: 4.8 },
  { id: "build", title: "Kamen Rider Build", genre: "kamen-rider", year: "2017", era: "Heisei", img: "/kr/456d61_ed354e3abfd74719a2b66f766f3ae3fe~mv2.jpg", rating: 4.9 },
  { id: "w", title: "Kamen Rider W", genre: "kamen-rider", year: "2009", era: "Heisei", img: "/kr/OIP (1).webp", rating: 5.0 },
  
  // Super Sentai
  { id: "king-ohger", title: "Ohsama Sentai King-Ohger", genre: "super-sentai", year: "2023", era: "Reiwa", img: "/super-sentai-king-ohger-team.jpg", rating: 4.9 },
  { id: "donbrothers", title: "Avataro Sentai Donbrothers", genre: "super-sentai", year: "2022", era: "Reiwa", img: "/placeholder.svg", rating: 4.7 },
  { id: "gokaiger", title: "Kaizoku Sentai Gokaiger", genre: "super-sentai", year: "2011", era: "Heisei", img: "/placeholder.svg", rating: 5.0 },
  
  // Ultraman
  { id: "blazar", title: "Ultraman Blazar", genre: "ultraman", year: "2023", era: "Reiwa", img: "/ultra/OIP (2).webp", rating: 4.8 },
  { id: "decker", title: "Ultraman Decker", genre: "ultraman", year: "2022", era: "Reiwa", img: "/ultra/ultraman_decker_global_poster_by_dhiotito_df2y5he-fullview.jpg", rating: 4.6 },
  { id: "tiga", title: "Ultraman Tiga", genre: "ultraman", year: "1996", era: "Heisei", img: "/ultra/ioKlOmo7OEd46KU4SXNaMXv0Mlh.webp", rating: 5.0 },

  // Chouseishin (BARU)
  { id: "gransazer", title: "Chouseishin Gransazer", genre: "chouseishin", year: "2003", era: "Heisei", img: "/chouseishin/gransazer.jpg", rating: 4.8 },
  { id: "justirisers", title: "Genseishin Justirisers", genre: "chouseishin", year: "2004", era: "Heisei", img: "/chouseishin/justirisers.jpg", rating: 4.7 },
  { id: "sazer-x", title: "Chousei Kantai Sazer-X", genre: "chouseishin", year: "2005", era: "Heisei", img: "/chouseishin/sazer-x.jpg", rating: 4.9 },
]
...
export default function GenrePage({ params }: { params: Promise<{ genre: string }> }) {
  ...
  // Ambil data genre, jika tidak ada pakai default placeholder
  ...
  // Filter series berdasarkan genre yang sedang dibuka
  const filteredSeries = allSeries.filter((s) => s.genre === genre)

  // Handle klik kartu: Jika bukan Gokaiger, munculkan alert
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-300">
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="text-white border-white/20 bg-white/5 px-4 py-2 text-sm uppercase cursor-pointer hover:bg-primary hover:border-primary transition-colors">
              All Eras
            </Badge>
            <Badge variant="outline" className="text-gray-400 border-white/10 px-4 py-2 text-sm uppercase cursor-pointer hover:text-white hover:border-white/30 transition-colors">
              Reiwa
            </Badge>
            <Badge variant="outline" className="text-gray-400 border-white/10 px-4 py-2 text-sm uppercase cursor-pointer hover:text-white hover:border-white/30 transition-colors">
              Heisei
        ...
        {filteredSeries.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in slide-in-from-bottom-5">
            ...
            <h3 className="text-2xl font-oswald font-bold text-gray-300 mb-2">No Series Found</h3>
            <p className="text-gray-500">We couldn't find any series for this category yet.</p>
          </div>
        )}
      </div>
        ...
        <AlertDialogContent className="bg-zinc-950 border border-white/10 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-400">
              This Wiki page is currently being updated. Only <strong>Kaizoku Sentai Gokaiger</strong> is available for preview right now. Please check back later!
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
