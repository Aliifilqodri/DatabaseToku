...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/logo-toku.png", // <--- Ganti dengan nama file logomu yang ada di folder 'public'
    // Bisa juga tambah shortcut icon kalau mau lebih spesifik:
    // shortcut: "/logo-toku.png",
    // apple: "/logo-toku.png",
  },
};
