...
const heroEntries = [
  {
    ...
    image: "/sentai/marvelous/Captain_Marvelous.webp", // Gambar Marvelous
    logo: "MARVELOUS",
    stats: {
      punch: "5.0 t",
      kick: "10.0 t",
  ...
  {
    id: "gokai-blue", // Link ke /character/gokai-blue
    title: "GOKAI BLUE",
    subtitle: "JOE GIBKEN",
    ...
    image: "/sentai/joe/Joe_Gibken.webp", // Gambar Joe
    logo: "JOE",
  ...
  },
  {
    ...
    image: "/sentai/luka/Luka_Millfy.webp", // Gambar Luka
    logo: "LUKA",
...
const wikiCategories = [
  {
    ...
    items: [
      ...
      { id: "gokai-blue", title: "Gokai Blue", year: "Joe" },
    ...
    <div className="min-h-screen bg-[#050505] font-sans selection:bg-primary selection:text-white overflow-x-hidden">
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        {heroEntries.map((entry, idx) => (
          ...
          >
            {/* Menggunakan object-cover dan alignment top agar wajah karakter terlihat jelas */}
            <img
              src={entry.image}
              alt={entry.title}
        ...
        <div className="absolute inset-0 flex items-center px-6 sm:px-12 lg:px-20 pt-16">
          <div className="grid w-full grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex justify-end animate-in fade-in zoom-in duration-1000 delay-200">
              <div className="glass-panel w-96 p-8 rounded-xl relative overflow-hidden border border-white/10">
                ...
                {cat.items.map((item, j) => (
                  <Link href={`/character/${item.id}`} key={j}>
                    <div className="aspect-[3/4] bg-zinc-900 border border-white/5 rounded-lg overflow-hidden group cursor-pointer relative hover:border-primary transition-colors">
                      {/* Placeholder logic - menggunakan inisial nama */}
                      <div className="absolute inset-0 bg-zinc-800 flex items-center justify-center">
                        <span className="font-oswald text-4xl text-white/10">
