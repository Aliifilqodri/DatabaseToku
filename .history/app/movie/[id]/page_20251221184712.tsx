...
// --- DATABASE MOVIE (DATA LENGKAP & RAPI) ---
...
export default function MovieDetailPage({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 -mt-80 relative z-10">
        <Link
          href="/movies"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="col-span-1">
            <div className="sticky top-24">
              ...
              <div className="mt-6 flex flex-col gap-3">
                ...
                <Button
                  disabled
                  className="w-full h-12 bg-zinc-800 text-zinc-500 border border-white/5 font-bold uppercase tracking-wider cursor-not-allowed hover:bg-zinc-800"
                >
                ...
                >
                  <Share2 className="mr-2" size={20} /> Share Title
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-2 space-y-10 animate-in fade-in slide-in-from-bottom duration-700 delay-200">
            {/* Title Section */}
            <div>
              <Badge className="bg-primary hover:bg-primary/80 text-white mb-3 uppercase tracking-wider px-3 py-1">
                {data.type}
              </Badge>
              <h1 className="text-4xl md:text-6xl font-oswald font-bold uppercase leading-none mb-3 text-white drop-shadow-lg">
                {data.title}
              </h1>
              <h2 className="text-xl text-gray-400 font-medium italic">
                {data.jpTitle}
              </h2>
            </div>

            {/* Metadata Row */}
            <div className="flex flex-wrap gap-6 text-sm font-mono text-gray-300 border-y border-white/10 py-6">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-oswald font-bold uppercase text-white flex items-center gap-2">
                <FileText className="text-primary" size={24} /> Synopsis
              </h3>
              <p className="text-gray-300 leading-relaxed text-lg border-l-4 border-white/10 pl-6">
                {data.synopsis}
              </p>
            </div>
            ...
            <div>
              <h3 className="text-2xl font-oswald font-bold uppercase text-white mb-6 flex items-center gap-2">
                <Users className="text-primary" size={24} /> Starring Cast
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {data.cast.map((actor, i) => (
                  ...
                  >
                    <div className="h-12 w-12 rounded-full bg-zinc-800 flex items-center justify-center text-gray-500 font-bold text-xs border border-white/10">
                      {actor.name.charAt(0)}
                    </div>
                    <div>
            ...
            <div className="bg-zinc-900/30 p-8 rounded-xl border border-white/10">
