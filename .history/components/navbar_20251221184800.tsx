...
const genres = [
  { name: "Super Sentai", href: "/introduction-to-tokusatsu-super-sentai.jpg" },
    ...
    >
      <div className="mx-auto max-w-7xl px-6 flex items-center justify-between">
            ...
            <DropdownMenuContent className="bg-black/90 border-white/10 text-gray-300 backdrop-blur-xl mt-2">
              {genres.map((genre) => (
                <DropdownMenuItem
                  key={genre.name}
                  asChild
                  className="focus:bg-primary/20 focus:text-primary cursor-pointer hover:bg-white/5"
                >
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Button className="hidden md:flex bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-none px-6 font-bold uppercase tracking-wider clip-angle border-none transition-all hover:scale-105">
