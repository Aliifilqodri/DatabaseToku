  ...
  tiga: {
    ...
    arsenal: [
      ...
      // --- WEAPONS & EQUIPMENT ---
      {
        name: "GUTS Hyper",
        type: "Weapon",
        img: "/ultra/arsenal/guts_hyper.webp",
